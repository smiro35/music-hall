...
VALUES ("Pat Benatar & Neil Giraldo"), ("The Tallest Man on Earth"), ("Josh Turner"), ("Bruce Hornsby and Music"), ("Bobby McFerrin");

INSERT INTO musicAPIs (artistID, spotify, youtube, instagram)
VALUES (1, 99, 100, 101), (2, 99, 100, 101), (3, 99, 100, 101), (4, 99, 100, 101), (5, 99, 100, 101);
...
VALUES (1, "3/8/17", 689, "5-7K", 23200, 59537, 715, 86,	83,	True, "FY17", "Rock", 5, 4, 4.5, "Great", "Great", "Correct"), (2,"5/10/20", 244, "<2K", 241,	9941, 244, 41, 29,NULL,"FY20", "Singer/Songwriter", 1, 1, 1, "Poor", "Poor", "Correct"), (3, "5/10/20", 244, "<2K", 241, 9941, 244, 41, 29, NULL, "FY20", "Singer/Songwriter", 1, 1, 1, "Poor", "Poor", "Correct"),(4, "3/1/20", 351, "<2K", 10000, 29670, 365, 85, 42, NULL, "FY20", "Rythm & Blues", 1, 3, 2, "Good", "Good", "Correct"), ( 5, "2/12/20", 241, "<2K", 16200, 17172, 265, 71, 29, NULL, "FY20", "World Music", 1, 3, 2, "Good", "Poor", "Wrong");